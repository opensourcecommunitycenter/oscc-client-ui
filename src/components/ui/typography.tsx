...
export function TypographyH1({ children, className = "" }: Typography) {
    return (
        <h1
            className={`scroll-m-20 font-extrabold tracking-tight text-6xl tracking-wide ${className}`}
        >
            {children}
        </h1>
    );
...
export function TypographyH2({ children, className = "" }: Typography) {
    return (
        <h2
            className={`scroll-m-20 mb-4 text-5xl text-headingForeground font-semibold tracking-tight first:mt-0 ${className}`}
        >
            {children}
        </h2>
    );
...
export function TypographyP({ children, className = "" }: Typography) {
    return (
        <p className={`text-2xl font-normal leading-10 ${className}`}>
            {children}
        </p>
    );
}
